...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/lector.css">
...
<form class="container"action="registroasistencia.php" method="post" >
    <input class="pe" type="char" name="carnet" autofocus onkeypress="return SoloNumeros(event)">
    <input class="bot" type="submit" value="enviar" >
</form>
<div class="contenedor">
<img src="img/ORDREST1.png">
</di>
